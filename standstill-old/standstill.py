...
class Standstill(tkinter.Tk):
    ...
    def tkinter_countdown(self):
        if not self.try_again:
            self.after(0, self.start_button.destroy)
            try:
                self.canvas_bg.delete("title")
                self.canvas_bg.delete("text")
            except ttk._tkinter.TclError:
                pass

        # Decrease the counter by 1
        self.counter = self.counter - 1  
        if self.counter < 0: 
            # Start listening silence and destroy canvas 
    ...
    def listening_silence(self, duration=10):
    ...
    def get_feedback(self):
        ...
        self.feedback_music_var = IntVar()
        self.feedback_music = LabelFrame(self, text=label, font=self.font)
        self.feedback_music.place(relx=0.5, rely=0.3, anchor='center')

        tkinter.Radiobutton(self.feedback_music, text='0', variable=self.feedback_music_var, value=0, height=3, width=10).grid(row=0, column=1)
        tkinter.Radiobutton(self.feedback_music, text='1', variable=self.feedback_music_var, value=1, height=3, width=10).grid(row=0, column=2)
        tkinter.Radiobutton(self.feedback_music, text="2", variable=self.feedback_music_var, value=2, height=3, width=10).grid(row=0, column=3)
        tkinter.Radiobutton(self.feedback_music, text="3", variable=self.feedback_music_var, value=3, height=3, width=10).grid(row=0, column=4)
        tkinter.Radiobutton(self.feedback_music, text='4', variable=self.feedback_music_var, value=4, height=3, width=10).grid(row=0, column=5)
        tkinter.Radiobutton(self.feedback_music, text="5", variable=self.feedback_music_var, value=5, height=3, width=10).grid(row=0, column=6)
        tkinter.Radiobutton(self.feedback_music, text="6", variable=self.feedback_music_var, value=6, height=3, width=10).grid(row=0, column=7)
        tkinter.Radiobutton(self.feedback_music, text='7', variable=self.feedback_music_var, value=7, height=3, width=10).grid(row=0, column=8)
        tkinter.Radiobutton(self.feedback_music, text="8", variable=self.feedback_music_var, value=8, height=3, width=10).grid(row=0, column=9)
        tkinter.Radiobutton(self.feedback_music, text="9", variable=self.feedback_music_var, value=9, height=3, width=10).grid(row=0, column=10)
        tkinter.Radiobutton(self.feedback_music, text="10", variable=self.feedback_music_var, value=10, height=3, width=10).grid(row=0, column=11)
        ...
        self.feedback_standstill_var = IntVar()
        self.feedback_standstill = LabelFrame(self, text=label, font=self.font)
        self.feedback_standstill.place(relx=0.5, rely=0.5, anchor='center')

        tkinter.Radiobutton(self.feedback_standstill, text='0', variable=self.feedback_standstill_var, value=0, height=3, width=10).grid(row=0, column=1)
        tkinter.Radiobutton(self.feedback_standstill, text='1', variable=self.feedback_standstill_var, value=1, height=3, width=10).grid(row=0, column=2)
        tkinter.Radiobutton(self.feedback_standstill, text="2", variable=self.feedback_standstill_var, value=2, height=3, width=10).grid(row=0, column=3)
        tkinter.Radiobutton(self.feedback_standstill, text="3", variable=self.feedback_standstill_var, value=3, height=3, width=10).grid(row=0, column=4)
        tkinter.Radiobutton(self.feedback_standstill, text='4', variable=self.feedback_standstill_var, value=4, height=3, width=10).grid(row=0, column=5)
        tkinter.Radiobutton(self.feedback_standstill, text="5", variable=self.feedback_standstill_var, value=5, height=3, width=10).grid(row=0, column=6)
        tkinter.Radiobutton(self.feedback_standstill, text="6", variable=self.feedback_standstill_var, value=6, height=3, width=10).grid(row=0, column=7)
        tkinter.Radiobutton(self.feedback_standstill, text='7', variable=self.feedback_standstill_var, value=7, height=3, width=10).grid(row=0, column=8)
        tkinter.Radiobutton(self.feedback_standstill, text="8", variable=self.feedback_standstill_var, value=8, height=3, width=10).grid(row=0, column=9)
        tkinter.Radiobutton(self.feedback_standstill, text="9", variable=self.feedback_standstill_var, value=9, height=3, width=10).grid(row=0, column=10)
        tkinter.Radiobutton(self.feedback_standstill, text="10", variable=self.feedback_standstill_var, value=10, height=3, width=10).grid(row=0, column=11)
        ...
        if not self.try_again:
            ...
            self.age_entry_var = IntVar()
            self.age_entry = LabelFrame(self, text=label, font=self.font)
            self.age_entry.place(relx=0.5, rely=0.7, anchor='center')

            tkinter.Radiobutton(self.age_entry, text="I prefer not to say", variable=self.age_entry_var, value=0, height=3, width=15).grid(row=0, column=1)
            tkinter.Radiobutton(self.age_entry, text="5 to 10", variable=self.age_entry_var, value=1, height=3, width=10).grid(row=0, column=2)
            tkinter.Radiobutton(self.age_entry, text="11 to 16", variable=self.age_entry_var, value=2, height=3, width=10).grid(row=0, column=3)
            tkinter.Radiobutton(self.age_entry, text="17 to 22", variable=self.age_entry_var, value=3, height=3, width=10).grid(row=0, column=4)
            tkinter.Radiobutton(self.age_entry, text='23 to 28', variable=self.age_entry_var, value=4, height=3, width=10).grid(row=0, column=5)
            tkinter.Radiobutton(self.age_entry, text="29 to 34", variable=self.age_entry_var, value=5, height=3, width=10).grid(row=0, column=6)
            tkinter.Radiobutton(self.age_entry, text="35 to 40", variable=self.age_entry_var, value=6, height=3, width=10).grid(row=0, column=7)
            tkinter.Radiobutton(self.age_entry, text='41 to 46', variable=self.age_entry_var, value=7, height=3, width=10).grid(row=0, column=8)
            tkinter.Radiobutton(self.age_entry, text="47 to 52", variable=self.age_entry_var, value=8, height=3, width=10).grid(row=0, column=9)
            tkinter.Radiobutton(self.age_entry, text="53 to 58", variable=self.age_entry_var, value=9, height=3, width=10).grid(row=0, column=10)
            tkinter.Radiobutton(self.age_entry, text="Older", variable=self.age_entry_var, value=10, height=3, width=10).grid(row=0, column=11)
    ...
    def store_data(self, minimum=0.0, maximum=0.1, threshold=0.001):
        ...
        if self.try_again:
            sql = f"UPDATE standstillUser SET standstillUserID = {self.standstill_id}, age = {self.age}, musicScore = {self.music_score}, silenceScore = {self.silence_score}, feedbackMusic = {int(self.feedback_music_var.get())}, feedbackStandstill = {int(self.feedback_standstill_var.get())} WHERE id = {self.id}"
            self.mysql_write(sql)
            ...
            # self.mysql_check_connect()
            self.age = int(self.age_entry_var.get())
            sql = f"UPDATE standstillUser SET standstillUserID = {self.id}, age = {self.age}, musicScore = {self.music_score}, silenceScore = {self.silence_score}, feedbackMusic = {int(self.feedback_music_var.get())}, feedbackStandstill = {int(self.feedback_standstill_var.get())} WHERE id = {self.id}"
            self.mysql_write(sql)
        # Get the best scores
        try:
    ...
    def gratulerer(self):
        ...
        self.after(0, self.age_entry.destroy())
    ...
    def display_scores(self):
        ...
        # Destrop after 5 seconds anyway
        self.after(5000, self.destroy_all)
    ...
    def head_tracker(self):
        ...
        # Retrieve OSC messages from local server
        server = BlockingOSCUDPServer(("127.0.0.1", 8000), dispatcher) # 8000 is Supperware quaternion (composite) port
...
if __name__ == "__main__":
    ...
    # database.cmd_query("SET SESSION wait_timeout=5")
    ...
    while True:
        Standstill(database=database, cursor=cursor)
        ROUND += 1
